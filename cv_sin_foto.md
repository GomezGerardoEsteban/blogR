---
title: "CV - Gerardo Esteban Gómez-Santiago"
format:
  pdf:
...
**Economista especializado en análisis de datos**
...
- Teléfono: +57 313 335 2017
- LinkedIn: [Gerardo Esteban Gómez](https://www.linkedin.com/in/gestebangomez/)
- GitHub: [GomezGerardoEsteban](https://github.com/GomezGerardoEsteban)
- YouTube: [\@GEsteban_Gomez](https://www.youtube.com/@GEsteban_Gomez)

**Idiomas:** Inglés (B2), Español (Nativo)

## Resumen

Soy un economista especializado en análisis cuantitativo y procesamiento de datos, con experiencia en métodos estadísticos, computacionales y visualización de resultados. Actualmente me desempeño como consultor en análisis cuantitativo, desarrollando productos en R e implementando técnicas de análisis en proyectos de investigación, análisis y evaluación de políticas públicas.

## Experiencia Laboral

**Científico de datos** — Evaluar SAS (04/2025 - Actualidad)
...
*Referencias: hnavarro\@evaluar.org.co - Hugo Navarro (responsable directo)*

**Docente en métodos cuantitativos** — Flacso México (09/2024 y 10/2025)
...
*Referencias: oscar.fontanelli\@flacso.edu.mx - Oscar Fontanelli (responsable directo)*

**Pasantía de Investigación** — Ecopetrol (08/2023)
...
*Referencias: jjaime98\@gmail.com - Jaime Jimenez (responsable directo)*

**Analista de control interno** — Molino Cañuelas (04/2021 - 07/2022)
...
*Referencias: mancinelli\@molca.com.ar - Carolina Mancinelli (Jefa Administración)*

**Profesor Adjunto** — Universidad Nacional de Río Cuarto (04/2021 - 07/2021)
...
- **Maestría en Gobierno y Asuntos Públicos**, Flacso México (2022 - 2024). Tesis: *Incorporación de energía solar y eólica en el sistema eléctrico colombiano. Una aplicación de la matriz insumo producto para analizar la política del sector.* Promedio **9.81**
- **Licenciatura en Economía**, Universidad Nacional de Río Cuarto (2015 - 2020). Tesis: *Desarrollo territorial en Colombia, un análisis de la evolución de los departamentos especializados en la producción de bienes transables bajo un nuevo tipo de inserción internacional.* Promedio **8.47**

### Certificados

- **Diplomado en tópicos avanzados de ciencia de datos.** Facultad de Ciencias Exactas, Universidad Nacional de Río Cuarto (2024).
- **Seminario de Big Data y ciencia de datos con R y Python.** Facultad de Ciencias Económicas, Universidad Nacional de Río Cuarto (2022).
- **Elementos de regresión y clasificación en lenguaje R.** Facultad de Ciencias Exactas, Universidad Nacional de Río Cuarto (2021).

## Publicaciones

- *Gómez-Santiago Gerardo E.*, Evolución de la producción petrolera en la orinoquia colombiana ¿Desarrollo o enclave?, **X Seminario Internacional sobre Desenvolvimento regional (2021) - Universidad de Santa Cruz do Sul**
- *Gómez-Santiago Gerardo E.*, Inflación estructural en Colombia, un análisis de su vínculo con la evolución del sector externo 2000 - 2018, **XXVII Jornadas de intercambio de conocimientos científicos y técnicos (2019) - FCE, Universidad Nacional de Río Cuarto**
- *Gómez-Santiago Gerardo E. & Orozco-García Carolina*, Effects of the type of municipal financing on subnational democracy in Colombia, **Latin American Conference on Subnational Governance 2024 - Escuela de Gobierno, Universidad de los Andes**
- *Borda Marianela, Gómez-Santiago Gerardo E., Paisio Gonzalo & Tello Diego*, Evidencias de disposición a pagar por bioinsumos que reducen GEI: oportunidades para estrategias ganar-ganar en la agricultura argentina, **Revista de Economía y Estadística, 63(1), 153-170. Universidad Nacional de Córdoba**
